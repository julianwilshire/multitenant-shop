...
SHARED_APPS = (
    ...
    'saleor.tenants', # you must list the app where your tenant model resides in
    'django.contrib.contenttypes'
...
TENANT_APPS = EXTERNAL_APPS	

INSTALLED_APPS = list(SHARED_APPS) + [app for app in EXTERNAL_APPS if app not in SHARED_APPS]
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,store.local"))
